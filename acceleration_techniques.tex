...
If the Jacobian of \(\mathcal R\) is not available and its estimate is of poor quality the global procedure may be compromised \citep{kelley_solving_2003}.
...
\label{tab:comparison_fft_galerkin_fem}
  ...
  \centering
    ...
    & & & \textbullet Improved stability over fixed-point.\\
    \hline
    \multirow{3}{*}{Broyden's family} & \multirow{3}{*}{\makecell[c]{2 \((n\times 1)\) vectors\\2 \((n\times (m-1))\) matrices}} & \multirow{3}{*}{1} & \textbullet Needs a first estimate for the invesre of the Jacobian \\
    & & & \textbullet Low number of function evauations\\
    & & & \textbullet Superlinear convergence when \(m=1\).\\
    \hline
    \multirow{3}{*}{Anderson's family} & \multirow{3}{*}{\makecell[c]{2 \((n\times 1)\) vectors\\2 \((n\times (m-1))\) matrices}} & \multirow{3}{*}{1} & \textbullet Need to choose the mixing parameter\\
    & & & \textbullet Simpler than Broyden's family\\
    & & & \textbullet Good results in FSI with \(\beta=-1\)\\
    \hline
